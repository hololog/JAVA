...
//		System.out.println(localVariable2);
		...
		// 로컬변수로 선언된 제어변수 i는 for문 중괄호가 끝난 후에는 제거되므로 접근 불가!
//		System.out.println(i);
	}
	
	public void instanceMethod2() {
		// 각 변수에 접근
		// 메서드 내에서는 멤버변수와 자신의 메서드에서 선언된 로컬변수에만 접근가능
...
//		System.out.println(localVariable); 		// 오류! 다른 메서드의 로컬변수
	}
}
...
public class Ex1 {
	...
	public static void main(String[] args) {
		...
		// 외부에서 접근할 수 없다! => 해당 메서드 내에서만 접근 가능
		// 외부에서 멤버 메서드를 호출할 수는 있음
