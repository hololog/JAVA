...
//		Integer n2 = new Integer(20);
		...
		// 1. 두 정수에 대한 대소 관계 비교
		System.out.println("num1과 num2중 큰 값: " + Integer.max(n1, n2));	// 오토언박싱
		System.out.println("num1과 num2중 작은 값: " + Integer.min(num1, num2));
...
//		}
		...
		// Character 클래스의 메서드를 활용한 대문자, 소문자, 숫자, 공백, 기타문자 판별
		ch = 'K';
