...
// => java.io 패키지 내의 2개의 클래스만 import 하는 경우

// java.io 패키지 내의 모든 클래스 파일을 import 하는 경우 만능문자 * 를 클래스명 대신 사용
import java.io.*;
...
public class Ex3 {
	...
	public static void main(String[] args) {
		 ...
		 *   package 문 아래쪽, 다른 코드들보다 윗쪽에 윗치해야함
		 *   (= package 문을 제외하면 가장 윗쪽 라인에 위치해야함)
		 * - 클래스명 지정 시 자동 완성 기능을 사용하여 import문을 자동 생성하거나
