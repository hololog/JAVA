...
public class Ex2 {
	...
	public static void main(String[] args) {
		 ...
		 * - 번호가 지정된 사물함에 물건을 보관하는 원리와 비슷
		 *   (사물함 번호는 중복되지 않지만, 사물함에 보관되는 물건은 중복될 수 있음)
...
//		map.put(3, "Oracle");
		...
		// Collectio values() : Map 객체 내의 모든 값 리턴
...
//		Set values = new HashSet(map.values());
		...
		// => 키와 값의 한쌍이 다른 키와 값의 한 쌍과 중복될 수 없으므로 Set 타입으로 관리됨
		...
		// boolean containsValue(Object key) : 해당 value 의 존재 여부 리턴
