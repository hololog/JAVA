...
public class Ex2 {
	...
	public static void main(String[] args) {
		...
		if(p3.equals(p4)) {
			System.out.println("p3와 p4의 실제값이 같다!");
		} else {
			System.out.println("p3와 p4의 실제값이 다르다!");
		}
...
class EqualsPerson {
	...
	// 모든 멤버변수가 같으면 true, 하나라도 다르면 false 리턴하도록 구현해야함
//	@Override
//	public boolean equals(Object obj) {	// p1.equals(p2)
////		if(this.age == obj.age) {}	// 참조 영역 축소로 인해 obj에서 age 변수가 보이지 않는다!
...
//			// 멤버변수 모두 같을 경우 true 리턴, 아니면 false 리턴
//			return true;
//		}
//		
//		return false;
//	}
	...
	// equal() 메서드 자동 오버라이딩 단축키 : Alt + Shift + S -> H
	@Override
