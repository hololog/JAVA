...
//		try {
//			대리2();	// ClassNotFoundException, SQLException 예외 위임되는 위치
//			대리1();	// ArithmeticException, NullPointerException 예외가 위임되는 위치
...
//		}
		...
		//    3. RumtimeException 과 Exception 으로 명시
...
//		}
		...
		// => 사원1() 메서드 선언부 마지막에 throws ArithmeticException 기술 해야한다!
		//    => 발생한 예외를 사원1() 메서드 호출한 대리1() 메서드로 던짐
