...
public class Ex2 {
	...
	public static void main(String[] args) {
		/*
		 * 날짜 및 시각 정보에 대한 형식화(Formatting) 클래스
		 * - 날짜 및 시각 정보를 개발자가 원하는 형식으로 표현하기 위한 클래스
		...
		Date now = new Date();   // 오늘 날짜 및 시각 정보를 기준으로 Date 객체 생성
		System.out.println(now); // Fri Feb 18 10:49:37 KST 2022
		...
		//	  => 지정된 패턴에 따라 Date 객체의 날짜 및 시각 표현을 변경한 문자열 리턴
